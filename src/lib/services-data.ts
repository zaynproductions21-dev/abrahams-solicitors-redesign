...
export const immigrationPages: ServicePage[] = [
  {
    ...
    "metaDescription": "Expert spouse visa solicitors with 95% success rate. Fixed fees, direct solicitor access. Free consultation for UK partner visa applications.",
    "heroTitle": "UK Spouse Visa Solicitors Who Fight Your Corner",
    "heroDescription": "Stop worrying about visa refusal destroying your future together. Our UK spouse visa solicitors have achieved a 95% success rate because we handle every detail correctly from the start. No call centres, no hidden fees — just direct access to experienced immigration lawyers who understand the stress you're facing.",
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "Our UK spouse visa solicitors achieve a 95% success rate by thoroughly preparing each application and catching common errors before submission. The national average for DIY applications is around 70%, with financial requirement mistakes being the leading cause of refusal."
      },
      {
        "question": "Can I get free immigration advice for my spouse visa application?",
        "answer": "Yes, we offer a free 30-minute consultation where you speak directly to a qualified immigration solicitor. You'll get honest advice about your case prospects and understand exactly what's needed for approval. Call 0800 123 4567 for free immigration advice uk telephone support."
      },
      {
      ...
      },
      {
        ...
        "answer": "If your spouse visa is refused, our visa refusal appeal specialists can help with administrative reviews or fresh applications. We achieve an 80% success rate on appeals by identifying exactly why the refusal occurred and building a stronger case. Appeal services start from £1,250."
      },
      {
  ...
  },
  {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "If refused, you can request an administrative review within 28 days (£372 fee) or make a fresh application addressing the refusal reasons. We have a 94% success rate in overturning refused citizenship applications through administrative review or reapplication strategies."
      },
      {
  ...
  },
  {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "Legally, no. Practically, absolutely. DIY applications succeed in only 70% of cases versus our 98% solicitor-prepared success rate. UKVI rejection means 6+ month delays and additional costs, making professional assistance cost-effective for most businesses."
      },
      {
  ...
  },
  {
    ...
    "heroDescription": "One wrong document can undo five years of lawful residence. Our ILR solicitors prepare indefinite leave to remain applications with a 96% approval rate, covering the Life in the UK Test, English-language evidence, continuous-residence calculations and suitability checks so you secure permanent UK status first time.",
    "badge": "Immigration Law",
    "sections": [
      {
  ...
  },
  {
    ...
    "heroDescription": "Visa refused? Application rejected? You're not alone. Every month, thousands of UK visa applications fail due to simple mistakes that experienced immigration solicitors prevent. Our specialist team has secured successful UK visa applications for over 15,000 clients across all visa categories — from spouse visas to business applications.",
    "badge": "Immigration Law",
    "sections": [
      {
  ...
  },
  {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "Our success rates are significantly higher than industry averages: Administrative Reviews 78% (industry average 30%), Immigration Appeals 89% (industry average 50%), and Fresh Applications 97% success on second attempt. Success depends on the refusal reasons and strength of your case. During your free consultation, we'll give you honest prospects based on your specific circumstances and the Home Office errors we can identify."
      },
      {
...
export const locationPages: ServicePage[] = [
  {
    ...
    "heroDescription": "London-based immigration solicitors offering fixed-fee visa, settlement and citizenship applications across the City, West End and Greater London. Direct solicitor access, a 95% success rate, and evening and weekend consultations to fit around your work — no call centres, no hidden costs.",
    "badge": "Immigration Law",
    "sections": [
      {
