...
export const immigrationPages: ServicePage[] = [
  {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "If your spouse visa is refused, our visa refusal appeal specialists can help with administrative reviews or fresh applications. We achieve an 80% success rate on appeals by identifying exactly why the refusal occurred and building a stronger case. Appeal services start from £2,000."
      },
      {
