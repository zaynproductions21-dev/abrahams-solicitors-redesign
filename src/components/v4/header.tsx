...
function DesktopDropdown({ item }: { item: NavItem }) {
  const href = item.href === "/" ? "/v4/" : `/v4${item.href}`;
  return (
    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link href="/v4/" className="flex items-center gap-3 shrink-0">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[340px] p-0 overflow-y-auto">
                ...
                <div className="p-6 space-y-3">
                  <Button asChild className="w-full bg-brand-red hover:bg-brand-red-dark text-white rounded-full h-12 uppercase tracking-wide text-xs font-semibold">
                    <Link href="/v4/contact-us/">Free Consultation</Link>
                  </Button>
