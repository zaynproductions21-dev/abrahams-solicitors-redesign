...
const immigrationLinks = [
  { label: "Spouse Visa Services", href: "/v4/uk-spouse-visa/" },
  { label: "British Citizenship", href: "/v4/british-citizenship/" },
  { label: "Visa Appeals & Reviews", href: "/v4/immigration/" },
  { label: "Asylum & Human Rights", href: "/v4/asylum-applications/" },
];

const otherLinks = [
  { label: "Housing Disrepair", href: "/v4/housing-disrepair/" },
  { label: "Workplace Accidents", href: "/v4/accidents-at-work/" },
  { label: "Road Traffic Claims", href: "/v4/car-accidents-claims/" },
  { label: "Serious Injury", href: "/v4/serious-injury-claims/" },
];

const quickLinks = [
  { label: "About Us", href: "/v4/about-us/" },
  { label: "Our Fees", href: "/v4/our-fees/" },
  { label: "Free Consultation", href: "/v4/contact-us/" },
];

const legalLinks = [
  { label: "Privacy Policy", href: "/v4/privacy-policy/" },
  { label: "Terms of Business", href: "/v4/terms-of-business/" },
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
            <Link href="/v4/" className="flex items-center gap-3 mb-8">
