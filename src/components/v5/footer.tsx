...
const immigrationLinks = [
  { label: "Spouse Visa Services", href: "/v5/uk-spouse-visa/" },
  { label: "British Citizenship", href: "/v5/british-citizenship/" },
  { label: "Visa Appeals & Reviews", href: "/v5/immigration/" },
  { label: "Asylum & Human Rights", href: "/v5/asylum-applications/" },
];

const otherLinks = [
  { label: "Housing Disrepair", href: "/v5/housing-disrepair/" },
  { label: "Workplace Accidents", href: "/v5/accidents-at-work/" },
  { label: "Road Traffic Claims", href: "/v5/car-accidents-claims/" },
  { label: "Serious Injury", href: "/v5/serious-injury-claims/" },
];

const quickLinks = [
  { label: "About Us", href: "/v5/about-us/" },
  { label: "Our Fees", href: "/v5/our-fees/" },
  { label: "Free Consultation", href: "/v5/contact-us/" },
];

const legalLinks = [
  { label: "Privacy Policy", href: "/v5/privacy-policy/" },
  { label: "Terms of Business", href: "/v5/terms-of-business/" },
  { label: "Cookie Policy", href: "/v5/cookie-policy/" },
];
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
            <Link href="/v5/" className="flex items-center gap-3 mb-8">
