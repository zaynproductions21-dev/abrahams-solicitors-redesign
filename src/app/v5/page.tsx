...
const services = [
  {
    ...
    href: "/v5/immigration/", price: "From £1,500",
  },
  {
    ...
    href: "/v5/housing-disrepair/", price: "No Win, No Fee",
  },
  {
    ...
    href: "/v5/british-citizenship/", price: "From £1,200",
  },
];
...
function ConsultationForm({ dark = false }: { dark?: boolean }) {
  ...
  return (
    <div className={`rounded-2xl p-8 ${dark ? "bg-white shadow-2xl" : "bg-white shadow-xl border border-slate-100"}`}>
      ...
      <form onSubmit={(e) => { e.preventDefault(); window.location.href = `/v5/contact-us/?name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&phone=${encodeURIComponent(phone)}`; }} className="space-y-3">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
              ...
              <Button asChild className="mt-6 bg-brand-red hover:bg-brand-red-dark text-white rounded-lg text-sm font-bold uppercase tracking-wide">
                <Link href="/v5/contact-us/">Ask Us Anything</Link>
              </Button>
            </div>
            {/* Right: accordion */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <div className="mt-3 flex items-center gap-4">
                <a href="https://wa.me/442033559823" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/60 hover:text-white transition-colors text-sm">
